...
export default function PokemonDetailClient() {
  ...
  return (
    <PageLayout>
      ...
      <PokemonStructuredData pokemon={pokemon} species={species || undefined} />
            ...
            <div className="text-center">
              ...
              <div className="relative w-80 h-80 mx-auto mb-6">
                <PokemonImage
                  ...
                  alt={`${pokemon.name.charAt(0).toUpperCase() + pokemon.name.slice(1)} - ${pokemon.types.map(t => t.type.name).join('/')} type Pokémon ${showShiny ? 'shiny form' : 'official artwork'}`}
